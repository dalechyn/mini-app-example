  ...
  return (
    <div>
      ...
      <button onClick={async () => {
        ...
        console.log('Contract Tx Hash', sendTxResponse.transactionHash)
        console.log('Contract Tx Address', sendTxResponse.address)
      }}>Send 1 wei</button>
      <hr/>
      ...
      }}>Approve weth to null address</button>
      <hr/>
      ...
      <button onClick={async () => {
        ...
        console.log('Sign Typed Data Signature', signTypedDataResponse.signature)
